...
const configData = [
  {
    ...
    prompt: `Use OpenStreetMap's OverPass API (*HIGHLY PREFERED*) and Turf.js (available in \`turf\`). Example: find closest rivers and calculate distance.`
  },
  {
    name: "OSRM",
    Topic: "Routing",
  ...
  },
  {
        ...
        prompt: `Use Open Meteo Elevation API when the analysis requires elevation on many objets. Example: show topology around a point.`
  },
  {
